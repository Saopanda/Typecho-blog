		...
		<main id="main" class="site-main" role="main">
			<article  class="hentry">
				<header class="entry-header">
					<h1 class="entry-title"><?php $this->title() ?>| <a ><small style="font-size: 16px"><?php $this->commentsNum(_t('NOTHING'), _t('<span class="noticom">1</span>条留言'), _t('<span class="noticom">%d</span>条留言')); ?></small></a></h1>
				</header>
		...
		<div id="respond_box">
			<div id="<?php $this->respondId(); ?>" class="comment-respond">
				...
				<form action="<?php $this->commentUrl() ?>" method="post" id="commentform">
					...
					<p>登录者： <a href="<?php $this->options->adminUrl(); ?>"><?php $this->user->screenName(); ?></a>&nbsp;&nbsp;<a href="<?php $this->options->logoutUrl(); ?>"title="退出">[ 退出 ]</a></p><br>
					<!-- 若当前用户未登录 -->
					<?php else: ?>
