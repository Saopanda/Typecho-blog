...
<section id="comments" class="comments">
	<!-- 隐藏评论 -->
	<div class="commentwrap comments-hidden" style="width: 146px;margin: 0 auto;">
		<div class="notification"><i class="iconfont">&#xe610;</i><?php $this->commentsNum(_t('添加评论'), _t('1条评论'), _t('%d条评论')); ?></div>
	</div>
		<!-- 输出评论信息 -->
