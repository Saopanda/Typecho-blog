...
var mNav = function(){
	$('.iconflat').on('click', function () {
	    ...
	    $('#main-container,#mo-nav,.openNav,#colophon').toggleClass('open');
	});
}
...
// Show & hide comments
	...
	$('.comments-hidden').click(function(){
		var value1 = $(document).scrollTop()
		value1 += 300
		$('html,body').animate({scrollTop: value1}, 300)
		$('.comments-main').slideDown(300);
		$('.comments-hidden').slideUp(300);
	});	
}
...
console.log("%cAkina for Typecho 1.8","background:#5f5f5f;color:#fff;margin:10px;padding:6px;","https://zhebk.cn");