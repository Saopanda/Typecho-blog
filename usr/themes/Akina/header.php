...
<head>
	...
	<link rel="stylesheet" href="'.theurl.'css/markdown.css" type="text/css" />
	...
	<?php endif; ?>
		...
		@media (max-width:1366px) {.top-feature {display:none} }
	 ...
	 <div class="openNav">
		<div class="iconflat">	 
			...
			<div class="site-branding">
			 <div class="site-title"><a href="<?php $this->options ->siteUrl(); ?>" >Saopanda</a></div>		  
			</div>
			<!-- logo 结束 -->
	 </div>	
	 <!-- 主页面显示 -->
	...
	<div class="site-top">
		...
		<div id="login-reg">
			...
			<div class="exloginbox">
				<a href="#" class="user-panel"><img alt="avatar" src="//q.qlogo.cn/g?b=qq&nk=<?php $this->options->QQ();?>&s=40" srcset="//q.qlogo.cn/g?b=qq&nk=<?php $this->options->QQ();?>&s=100 2x" class="avatar avatar-110 photo"></a>
